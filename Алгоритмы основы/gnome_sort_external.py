...
sorted_union, u_time_spent, u_steps, u_comparisons = gnome_sort(union)
sorted_intersection, i_time_spent, i_steps, i_comparisons = gnome_sort(intersection)
sorted_difference, d_time_spent, d_steps, d_comparisons = gnome_sort(difference)
sorted_s_difference, s_time_spent, s_steps, s_comparisons = gnome_sort(symm_difference)
